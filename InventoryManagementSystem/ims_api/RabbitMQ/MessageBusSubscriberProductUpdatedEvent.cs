...
{
    public class MessageBusSubscriberProductUpdatedEvent : BackgroundService
    {
        ...
        public MessageBusSubscriberProductUpdatedEvent(IConfiguration configuration, IServiceScopeFactory scopeFactory)
        {
        ...
        private void InitializeRabbitMQ()
        {
            ...
            _channel.QueueBind(queue: _queueName,
                exchange: "trigger",
                routingKey: "ProductUpdatedEvent");
