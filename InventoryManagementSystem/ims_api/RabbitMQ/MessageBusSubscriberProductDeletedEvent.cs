...
{
    public class MessageBusSubscriberProductDeletedEvent : BackgroundService
    {
        ...
        public MessageBusSubscriberProductDeletedEvent(IConfiguration configuration, IServiceScopeFactory scopeFactory)
        {
        ...
        private void InitializeRabbitMQ()
        {
            ...
            _channel.QueueBind(queue: _queueName,
                exchange: "trigger",
                routingKey: "ProductDeletedEvent");
