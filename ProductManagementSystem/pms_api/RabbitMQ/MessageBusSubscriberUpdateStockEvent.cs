...
namespace ProductManagementSystem.API.RabbitMQ
{
    public class MessageBusSubscriberUpdateStockEvent : BackgroundService
    {
        ...
        public MessageBusSubscriberUpdateStockEvent(IConfiguration configuration, IServiceScopeFactory scopeFactory)
        {
