...
{
    public class MessageBusSubscriberOrderApprovedEvent : BackgroundService
    {
        ...
        public MessageBusSubscriberOrderApprovedEvent(IConfiguration configuration, IServiceScopeFactory scopeFactory)
        {
